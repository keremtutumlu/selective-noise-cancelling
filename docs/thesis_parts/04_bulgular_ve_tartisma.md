...
![Şekil 4.12](../thesis_figures_v3.0/13_spectrogram_clock_alarm.png)

**Şekil 4.12:** Çalar saat sınıfı için karışım, hedef ve model kestirimi spektrogramları.

![Şekil 4.13](../thesis_figures_v3.0/13_spectrogram_helicopter.png)

**Şekil 4.13:** Helikopter sınıfı için karışım, hedef ve model kestirimi spektrogramları.

![Şekil 4.14](../thesis_figures_v3.0/13_spectrogram_vacuum_cleaner.png)
...
![Şekil 4.15](../thesis_figures_v3.0/14_removal_demo.png)
